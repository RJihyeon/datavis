...
function Alone() {
    ...
    useEffect(() => {
        ...
        d3.csv("/domestic_famtype/element_alone(o).csv").then((data) => { // 초기 csv 파일 표시
            d3.select("button[data-src='/domestic_famtype/element_alone(o).csv']").classed('active', true);
    ...
    useEffect(() => {
        d3.selectAll("button").on("click", function () {
            ...
            const csvFile = this.getAttribute("data-src");
